...
// Source: github.com/ozonmp/lgc-location-api/internal/retranslator/sender (interfaces: EventSender)
...
func (m *MockEventSender) Send(arg0 *model.LocationEvent) error {
	m.ctrl.T.Helper()
